...
public class EngineGUIless {
	...
	public EngineGUIless(int timeout) {
		this(timeout, 16);
	}

	public EngineGUIless() {
		this(60, 16);
	}
	 ...
	 */
	public EngineGUIless(int timeout, int cacheSize) {
		...
		EngineGUIless.timeout = timeout;
		EngineGUIless.cacheSize = cacheSize;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		EngineGUIless eee = null;
		eee = new EngineGUIless(timeout, cacheSize);
		eee.run();
