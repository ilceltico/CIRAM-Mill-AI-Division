...
public class MTDVariantTransposition implements IMinimax{
	...
	public MTDVariantTransposition(ITieChecker tieChecker, ITranspositionTable transpositionTable) {
	...
	public ValuedAction minimaxDecision(IState state, int maxDepth) {
		...
		System.out.println("MTD-f Variant Transposition:");
