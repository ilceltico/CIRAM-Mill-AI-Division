...
public class NegascoutHistory implements IMinimax{
	...
	public NegascoutHistory(ITieChecker tieChecker, IHistoryTable historyTable) {
	...
	public ValuedAction minimaxDecision(IState state, int maxDepth) {
		...
		System.out.println("Negascout History:");
